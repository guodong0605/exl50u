function imgout=PlasmaEdgeDetect(shotnum,t,showfig,showellipse)
...
if nargin<3 showfig=0;end
if nargin<4 showellipse=0;end
[info,frame,~]=downloadcine(shotnum,t,t);
...
%%
cy=427;                  % Vertical pixel center
cx= 668.5000;
ratio=3.215/1e3;           % unit mm/pixel;
...
ue3(end+1:end+100)=0.262*ones(100,1);ve3(end+1:end+100)=linspace(-0.2,0.2,100);
Re3=Re(Re>temp2);Ze3=Ze(Re>temp2);
Re3(end+1:end+100)=0.262*ones(100,1);Ze3(end+1:end+100)=linspace(-0.2,0.2,100);
ellipse_fit1 = fit_ellipse(ue3,ve3);
ellipse_fit2 = fit_ellipse(Re3,Ze3);
%----------------------------------------------------
imgout=struct;
imgout.threshold=threshold;
imgout.a=ellipse_fit2.a;
imgout.b=ellipse_fit2.b;
...
if showfig
    ...
    if showellipse
        ...
        t0=text(-2,1.3,['shot:',num2str(shotnum),'@',num2str(t),'s']);
