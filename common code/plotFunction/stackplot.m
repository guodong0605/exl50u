function handleOut = stackplot(Waveform,iTitle, Xlabel,style)
...
for i = 1:wavenum
    ...
    switch length(temp)
        case 2
            if style
                hg{i} = plot(temp{1:end},':o','Color','k', 'Tag', stackplottag,'linewidth',2,'MarkerSize',8,'MarkerFace',colors(i,:),'MarkerEdgeColor',colors(i,:));
            else
        ...
        case 3
            if style
                hg{i} = plot(temp{1:2},':o','Color','k', 'Tag', stackplottag,'linewidth',2,'MarkerSize',8,'MarkerFace',colors(i,:),'MarkerEdgeColor',colors(i,:));
            else
