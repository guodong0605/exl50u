function [info,picture,t]=readcine(cinefilename,t1,t2,dframe,isframe)
...
k=1;
if frm_min==0
    nums=length(frm_min:dframe:frm_max)-2;
else
...
if isframe
    t=frm_min:dframe:frm_max;
else
    t=times(frm_min:dframe:frm_max);
end
fclose(fid);
