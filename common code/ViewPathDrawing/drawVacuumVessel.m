function vvhandle=drawVacuumVessel()
...
a1=patch(vv_out(:,1)/1e3,vv_out(:,2)/1e3,[0,0,0]);
hold on;a2=patch(vv_in(:,1)/1e3,vv_in(:,2)/1e3,[1,1,1]);
hold on;a3=patch(post(:,1)/1e3,post(:,2)/1e3,[0.4,0.4,0.4]);
vvhandle={a1,a2,a3};
end