...
% Last Modified by GUIDE v2.5 13-Mar-2024 10:12:18
...
%=------------------------------------------
   warning off
    ...
    mystep=1;
    undistort_flag=0;
    camera=handles.pushbutton8.Value;
    ...
    try
        ...
        [info,picture]=downloadcine(shotnum,time,time,1,camera);
        global img1;
